        ...
        <div class="content">
            ...
            <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" name="update" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="workName" class=" form-control-label">Work Name</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="workName" name="workName" value="<?php echo $editname; ?>" class="form-control" ></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="city" class=" form-control-label">City</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="city" name="city" value="<?php echo $editcity; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea name="description" id="description" rows="9"  class="form-control"><?php echo $editdescription; ?></textarea></div>
                                    </div>
                                ...
                                <?php
                                    if ($_POST){
                                        if($editname != $_POST["workName"] || $editcity != $_POST["city"] || $editdescription != $_POST["description"]){
                                            $name = $_POST["workName"];
                                            $city = $_POST["city"];
                                            $category = $_POST["category"];
                                            $description =$_POST["description"];
    
                                            $addproject = $connection->query("update ourworks SET work_name='$name', work_city='$city', category='$category', description='$description'");
                                            if($addproject){
                                                echo '<script>
                                                alert("Datas updated!");
                            ...
                            <a href="addphoto.php?id=<?php echo $id;?>" type="submit" class="btn btn-primary btn-sm">
